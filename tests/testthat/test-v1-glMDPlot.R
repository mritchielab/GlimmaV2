...
test_that("MD Plot runs for DGELRT", {
    ...
    load("test-v1_data_DGELRT.RData")
    counts <- counts$counts
    display.columns <- c("Symbols", "GeneID")
    ...
    load("test-v1_data_little_mait_DGELRT.RData")
...
test_that("MD Plot runs for DGEExact", {
    ...
    load("test-v1_data_DGEExact.RData")
    counts <- counts$counts
    display.columns <- c("Symbols", "GeneID")
...
test_that("MD Plot runs for MArrayLM", {
    ...
    load("test-v1_data_invalid_names_glMDPlot.RData")
